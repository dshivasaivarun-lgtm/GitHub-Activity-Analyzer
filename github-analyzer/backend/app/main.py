...
app = FastAPI(title="GitHub Activity Analyzer", version="1.0.0")

# CORS — add your Vercel URL via ALLOWED_ORIGINS env var on Render
...
@app.get("/ping")
def ping():
    """Health check to keep Render free tier awake."""
    return {"status": "ok"}
